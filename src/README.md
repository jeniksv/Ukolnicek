...
Receives JSON data from the TCP connection, accumulates the received data until a complete JSON object is formed, deserializes it back into an object of type `T`, and returns the deserialized object.
